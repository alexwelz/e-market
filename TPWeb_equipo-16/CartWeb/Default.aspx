 ...
 <% if ((List<Domain.Item>)Session["filteredItems"] != null)
    ...
    <div class="row" style="margin-top: 50px; margin-left: 25px; margin-right:25px;">
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-2">
            <div class="card" style="border-color:darkgray;">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <a href="<%: ResolveUrl("~/Detail.aspx?id=" + item.Id) %>" class="btn btn-outline-secondary" style="font-weight: bold; border-color:dimgrey;">+</a>
                    </div>
                    </center>
                </div>
